 #./kiteq -bind=:23800 -pport=23801 -db="file://.?cap=10000000&checkSeconds=10" -topics=trade  -zkhost=localhost:2181 -logxml=./log/log_test.xml -deliveryFirst=true
 ./kiteq -clusterName=bibi_dev -configFile=../kiteq-cluster-config/kiteq-topics.toml
